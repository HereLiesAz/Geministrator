...
2.  **Core Loop**:
    ...
    -   The user interacts with the Jules agent in the **Session Screen**, sending messages and reviewing the agent's responses and activities via the A2A protocol.
