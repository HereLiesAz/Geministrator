...
This document provides an detailed overview of the various screens within the Jules IDE application.
...
The `EditorScreen` is the code editor. It uses the [Sora Editor](https://github.com/Rosemoe/sora-editor), a native Android code editor, to provide a rich and performant code editing experience. It includes features like syntax highlighting, autocompletion, and in-line diagnostics.
