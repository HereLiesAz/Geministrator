...
object TaskRunTransitions {
    private val allowed: Map<TaskRunStatus, Set<TaskRunStatus>> = mapOf(
        ...
        TaskRunStatus.Blocked to setOf(TaskRunStatus.Ready, TaskRunStatus.Running, TaskRunStatus.Verifying, TaskRunStatus.Completed, TaskRunStatus.Failed, TaskRunStatus.Cancelled),
        ...
        TaskRunStatus.AwaitingApproval to setOf(TaskRunStatus.Running, TaskRunStatus.Failed, TaskRunStatus.Retrying, TaskRunStatus.Escalated, TaskRunStatus.Cancelled),
        ...
        TaskRunStatus.Verifying to setOf(TaskRunStatus.Completed, TaskRunStatus.Retrying, TaskRunStatus.Failed, TaskRunStatus.Escalated, TaskRunStatus.Cancelled),
        TaskRunStatus.Retrying to setOf(TaskRunStatus.Planning, TaskRunStatus.AwaitingApproval, TaskRunStatus.Running, TaskRunStatus.Verifying, TaskRunStatus.Completed, TaskRunStatus.Failed, TaskRunStatus.Escalated, TaskRunStatus.Cancelled),
